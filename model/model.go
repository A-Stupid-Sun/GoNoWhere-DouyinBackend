...
type Model struct {
	ID       int64     `gorm:"type:BIGINT;unsigned;primaryKey;autoIncrement"`
...
type User struct {
	ID       int64     `gorm:"type:int;AUTO INCREMENT;primaryKey;"`
	CreateAt time.Time `gorm:"type:timestamp;not null;default:current_timestamp()"`
	gorm.DeletedAt
...
type UserLogin struct {
	ID       int64     `gorm:"type:int;AUTO_INCREMENT;unsigned;primaryKey;"`
	CreateAt time.Time `gorm:"type:timestamp;not null;default:current_timestamp()"`
	UpdateAt time.Time `gorm:"type:timestamp;not null;default:current_timestamp()"`
	gorm.DeletedAt
...
type Favorite struct {
	ID       int64     `gorm:"type:BIGINT;unsigned;primaryKey;autoIncrement;comment:自增主键"`
